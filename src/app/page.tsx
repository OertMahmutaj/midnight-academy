...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <footer className="px-6 py-12 max-w-6xl mx-auto border-t border-zinc-900 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] font-mono text-zinc-600">

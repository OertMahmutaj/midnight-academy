...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed top-0 right-0 h-screen w-full sm:w-[350px] bg-zinc-950 border-l border-zinc-900 z-45 p-12 pt-28 flex flex-col justify-between transform transition-transform duration-300 ease-in-out z-40 ${
      ...
      >
        ...
        <div className="flex flex-col space-y-8 font-bold text-xl tracking-tight">
          ...
          {/* Smooth Scroll Anchor Link to Application Form */}
          <a 
            href="#book" 
            onClick={toggleMenu}
            className="text-zinc-500 hover:text-white transition duration-200 flex items-center gap-4 group"

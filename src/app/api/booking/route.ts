...
export async function POST(request: Request) {
  try {
    ...
    const { name, email, instagram, experience } = body;
      ...
      embeds: [
        {
          ...
          fields: [
            ...
            { name: '📸 Instagram Handle', value: `@${instagram.replace('@', '')}`, inline: true },
            { name: '📧 Email Address', value: email, inline: false },
            { name: '💬 Design Background', value: experience || 'No prior experience stated.', inline: false },
          ],
